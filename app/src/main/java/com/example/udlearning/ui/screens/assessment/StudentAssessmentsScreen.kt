...
fun StudentAssessmentsScreen(
    ...
    viewModel: StudentAssessmentsViewModel = androidx.lifecycle.viewmodel.compose.viewModel()
) {
    LaunchedEffect(Unit) {
        viewModel.fetchStudentAssessments()
    }
    ...
    Column(
        ...
        Column(modifier = Modifier.padding(horizontal = 24.dp)) {
            ...
            Row(
                ...
                val filters = listOf("Todas", "Activas", "Pendientes", "Finalizadas")
        ...
        if (viewModel.isLoading) {
            ...
            Box(modifier = Modifier.fillMaxSize().padding(24.dp), contentAlignment = Alignment.Center) {
                Text("No se encontraron evaluaciones.", color = White)
            }
        } else {
            LazyColumn(
