...
import com.example.udlearning.ui.screens.assessment.TeacherAssessmentsViewModel
import com.example.udlearning.ui.screens.session.SessionCard
import com.example.udlearning.ui.screens.session.FilterChip
import com.example.udlearning.ui.theme.color.*

@Composable
fun TeacherAssessmentsScreen(
    navController: NavController,
    viewModel: TeacherAssessmentsViewModel = androidx.lifecycle.viewmodel.compose.viewModel()
) {
    ...
    Column(
        ...
        if (viewModel.isLoading) {
            ...
            Box(modifier = Modifier.fillMaxSize().padding(24.dp), contentAlignment = Alignment.Center) {
                Text("No se encontraron evaluaciones creadas por ti.", color = White)
            }
        } else {
            LazyColumn(
                ...
                item {
                    Text(
                        text = "${viewModel.filteredSessions.size} evaluaciones encontradas",
